            ...
            if (n == hour) {
                ...
                for (Data d : array) {
                    ...
                    if (limit == 0L) {
                        ...
                        Notification notifi = new Notification(R.drawable.ic_launcher, "期限切れのお知らせ", System.currentTimeMillis());

                        Intent intent = new Intent(getApplicationContext(), MainActivity.class);
                        PendingIntent content = PendingIntent.getActivity(getApplicationContext(), 0, intent, 0);

                        notifi.setLatestEventInfo(getApplicationContext(), "Checker", "期限切れのお知らせ", content);
